    ...
    For more information about DataTables, please visit the <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p>
     -->
        ...
        <div class="card-header py-3" >
                <div class="row">
                    <div class="col-sm-6">
                        <h6 class="m-0 font-weight-bold text-primary" align="left">Country List</h6>
                    </div>
                    <div class="col-sm-6">
                        <a href="<?php echo base_url()?>Admin/showaddcountry">
                        <h6 class="m-0 font-weight-bold text-primary" align="right">Add Country</h6>
                        </a>
                    </div>
                </div>
            </div>
