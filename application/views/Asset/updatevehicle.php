                                            ...
                                            foreach($data as $row)
                                            {
                                                ...
                                                <table align="center" width="100%" border="1" cellspacing="5" cellpadding="5">
                                                    <tr>
                                                        ...
                                                        <td width="329"><input type="text" name="vehicle" value="<?php echo $row->name; ?>"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="230">Enter Your Email </td>
                                                        <td width="329"><input type="number" name="cost" value="<?php echo $row->cost; ?>"/></td>
                                                    </tr>
                                                    
                                                    <!-- THIS IS FOR IMAGE UPLOADING  -->
                                                    <tr>
                                                        <?php echo form_open_multipart('Admin/updatevehicle');?>
